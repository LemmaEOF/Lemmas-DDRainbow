...
ret.Redir = function(sButton, sElement)
	...
	not string.find(sElement, "Explosion") then
		...
		string.find(sElement, "Roll") then
			--oh god I don't wanna make unique rolls for solo nobody plays solo
			if (sButton == "UpLeft" or sButton == "UpRight") and
			string.find(sElement, "Roll") then
				return ret.RedirTable[sButton], sElement;
			end
...
ret.Blank =
{
	--Someday I'll manage to make DDR reverse-friendly...
